...
{% hint style="info" %}
Наличие или отсутствие у процесса родительского процесса или лидера группы никак не влияет на сам процесс и носит лишь информационный характер. Вы можете использовать о родительском процессе или лидере группы в логике реализации вашего приложения.
{% endhint %}
